...
// Generated by the Makefile from src/bootstrap.pl -- defines BOOTSTRAP_PL_SRC
// (byte array, not NUL-terminated) and BOOTSTRAP_PL_SRC_LEN.
#include "bootstrap_pl.h"
...
Prolog *prologCreate(void) {
    ...
    // what. BOOTSTRAP_PL_SRC/BOOTSTRAP_PL_SRC_LEN come from
    // build/bootstrap_pl.h, generated from that file by the Makefile.
    consultBuffer(pl, BOOTSTRAP_PL_SRC, BOOTSTRAP_PL_SRC_LEN);
    return pl;
}
